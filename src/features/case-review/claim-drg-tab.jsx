  ...
  return (
    <div className="space-y-4">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        <Card className="p-4 border border-border shadow-none space-y-1">
        ...
        <Card className="p-4 border border-emerald-500/30 bg-emerald-500/10 shadow-none space-y-1">
          <p className="text-xs font-semibold text-emerald-700 dark:text-emerald-300">Adjusted RW (AdjRW)</p>
          <p className="text-xl font-bold text-emerald-600 dark:text-emerald-400">2.7890</p>
          <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold">+0.5656 (Comorbidity impact)</p>
        </Card>
        ...
        <Card className="p-4 border border-primary/20 bg-primary/5 shadow-none space-y-1">
          ...
          <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold">+40,270 ฿ (+58.8%)</p>
        </Card>
      </section>

      {/* DRG Calculation Details */}
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.8fr)]">
        <Card className="p-5 border border-border shadow-none space-y-4">
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr className="bg-emerald-500/10">
                  <td className="p-3 font-semibold text-emerald-700 dark:text-emerald-300">3. Secondary Dx (CC/MCC)</td>
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400">E66.01 + I10</td>
                  <td className="p-3 text-emerald-700 dark:text-emerald-300">Morbid Obesity (CC) + Hypertension</td>
                  <td className="p-3 text-right font-bold text-emerald-600 dark:text-emerald-400">+0.5656</td>
                </tr>
                <tr>
        ...
        <Card className="p-5 border border-border shadow-none space-y-4">
          ...
          <div className="space-y-2.5 text-xs">
            <div className="flex items-start gap-2.5 rounded-lg bg-emerald-500/10 border border-emerald-500/25 p-2.5">
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span>
              <div>
                <p className="font-semibold text-emerald-700 dark:text-emerald-300">สิทธิการรักษาตรงตามเกณฑ์</p>
                <p className="text-emerald-600 dark:text-emerald-400">บัตรทอง (UC) / กองทุน UC รพ.ศิริสุข</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5 rounded-lg bg-emerald-500/10 border border-emerald-500/25 p-2.5">
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span>
              <div>
                <p className="font-semibold text-emerald-700 dark:text-emerald-300">บันทึกหัตถการและอุปกรณ์ครบ</p>
                <p className="text-emerald-600 dark:text-emerald-400">ลงรหัสข้อสะโพกเทียม Cementless ถูกต้อง</p>
              </div>
            </div>

            <div className="flex items-start gap-2.5 rounded-lg bg-amber-500/10 border border-amber-500/25 p-2.5">
              <span className="text-amber-600 dark:text-amber-400 font-bold">!</span>
              <div>
                <p className="font-semibold text-amber-700 dark:text-amber-300">รอ Coder ยืนยันรหัส E66.01</p>
                <p className="text-amber-600 dark:text-amber-400">เพื่อส่งเคลมในอัตรา AdjRW 2.7890</p>
              </div>
            </div>
          </div>
