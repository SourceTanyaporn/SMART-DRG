        ...
        <div className="grid grid-cols-[1fr_170px_60px] items-center gap-3 border-b border-[#edf0f4] py-2.5">
            ...
            {type === "select" ? (
                <select
                    ...
                    className="h-7 rounded-md border border-[#dfe2e9] bg-white px-2 text-[11px] text-slate-600 outline-none focus:border-[#6680ef]"
                >
            ...
            <div className="flex h-full min-h-0 flex-col">
                ...
                {selectedFormIds.length === 0 ? (
                    ...
                    <>
                        ...
                        <div className="shrink-0 border-t border-[#e5e7eb] bg-white pt-2.5">
